...
interface ApiService {
    ...
    @POST(Constants.Endpoints.SET_CURRENCY)
    ...
    ): Response<ApiResponse<NotificationSettingsData>>
    ...
    suspend fun withdrawBankTransfer(
        @Body request: BankWithdrawRequest
    ): Response<ApiResponse<WithdrawResponse>>
...
data class InvestmentProduct(
    ...
    val min_investment_formatted: String? = null,
    val max_investment: String? = null,
    val expected_returns: String? = null,
    val risk_level: String? = null,
    val risk_level_label: String? = null,
    ...
    val units_available: Int? = null,
    val is_featured: Boolean = false,
    val rating_average: String? = null,
    val rating_count: Int = 0,
    val requires_kyc: Boolean? = null,
    val terms_conditions: String? = null,
    val category: InvestmentCategory? = null,
    val partner: InvestmentPartner? = null,
    val features: List<String>? = null,
    val documents: List<InvestmentDocument>? = null,
    val reviews: List<InvestmentReview>? = null
) : Parcelable {
...
@Parcelize
data class InvestmentReview(
    val id: Int,
    val rating: Int,
    val title: String? = null,
    val review: String? = null,
    val user_name: String? = null,
    val is_verified_purchase: Boolean = false,
