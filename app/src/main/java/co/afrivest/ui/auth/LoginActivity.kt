...
import co.afrivest.databinding.ActivityLoginBinding
...
class LoginActivity : BaseActivity() {
    ...
    private fun observeViewModel() {
        ...
        viewModel.navigateToCurrencySetup.observe(this) { navigate ->
            if (navigate) {
                startActivity(Intent(this, co.afrivest.ui.onboarding.CurrencySelectionActivity::class.java))
                finish()
            }
        }
    }
