...
import co.afrivest.ui.auth.models.Country
        ...
        when {
            password.isEmpty() -> {
                ...
                _passwordStrength.value = when (strength) {
                    co.afrivest.utils.PasswordStrength.WEAK -> PasswordStrength.WEAK
                    co.afrivest.utils.PasswordStrength.MEDIUM -> PasswordStrength.MEDIUM
                    co.afrivest.utils.PasswordStrength.STRONG -> PasswordStrength.STRONG
                }

                when (result) {
                    is co.afrivest.utils.ValidationResult.Success -> {
                        _passwordState.value = FieldState.Valid
                    }
                    is co.afrivest.utils.ValidationResult.Error -> {
