...
class OTPActivity : BaseActivity() {
    ...
    private fun observeViewModel() {
        ...
        viewModel.timeRemaining.observe(this) { time ->
            ...
            if (time < 60) {
                binding.tvTimer.setTextColor(getColor(co.afrivest.R.color.error_red))
            } else {
                binding.tvTimer.setTextColor(getColor(co.afrivest.R.color.text_secondary))
            }
        }
        ...
        viewModel.canResend.observe(this) { canResend ->
            ...
            if (canResend) {
                binding.tvResend.setTextColor(getColor(co.afrivest.R.color.primary_gold))
            } else {
                binding.tvResend.setTextColor(getColor(co.afrivest.R.color.text_disabled))
            }
        }
