package co.afrivest.ui.insurance
...
import co.afrivest.databinding.ActivityInsuranceListBinding
import co.afrivest.ui.base.BaseActivity
import co.afrivest.ui.investments.ProductDetailActivity
import co.afrivest.ui.investments.adapters.InvestmentProductsAdapter
...
class InsuranceListActivity : BaseActivity() {
    ...
    private fun setupProviderFilter(providers: List<co.afrivest.data.api.InsuranceProvider>) {
        // Add "All" chip
